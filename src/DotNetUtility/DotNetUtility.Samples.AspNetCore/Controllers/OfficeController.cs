using DotNetUtility.Samples.AspNetCore.Models;
...
namespace DotNetUtility.Samples.AspNetCore.Controllers
{
    public class OfficeController : Controller
    {
        ...
        public IActionResult ExportXlsx()
        {
            ...
            contentDisposition.SetHttpFileName("导出的Excel.xlsx");
            Response.Headers[HeaderNames.ContentDisposition] = contentDisposition.ToString();
            NPOIHelper.DatasetToExcel(ds, Response.Body, ExcelFormat.Xlsx);
            return new EmptyResult();
        }
        [HttpPost]
        public IActionResult ImportXlsx(IFormFile import)
        {
            DataSet ds = null;
            try
            {
                ...
                {
                    ds = NPOIHelper.ExcelToDataset(import.OpenReadStream());
                }
            }
            catch (Exception)
            {
